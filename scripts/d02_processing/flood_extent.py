...
def calc_extent():
    ...
    unions_shp = gpd.read_file(os.path.join(SHP_DIR, 'bdg_shp/bgd_admbnda_adm4_bbs_20180410.shp'))
    ...
    output_df.to_excel(os.path.join(DATA_DIR, 'Sentinel-1-BGD-Flooding-TOTAL.xlsx'))
    return output_df
